...
import fis.java.training.model.Person;
import fis.java.training.model.enums.EmploymentStatus;
import fis.java.training.model.enums.Rank;
...
public class DetectiveTest {
    ...
    public static List<Detective> create3Detective(){
        ...
        person.setFirstName("tuong");
        person.setLastName("Nong Van");
