...
class DetectiveDAOMemImplTest {
    ...
    void get() {
        ...
        assertEquals("Huong", detective.getPerson().getFirstName());
        assertNotEquals("Hung", detective.getPerson().getFirstName());
    ...
    void remove(){
        ...
        assertEquals("Hoai", detective.getPerson().getFirstName());
